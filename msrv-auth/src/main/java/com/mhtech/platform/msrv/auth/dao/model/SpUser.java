...
public class SpUser {
    ...
    public SpUser(Long id, String userCode, String name, String password, String companyCode, String orgCode,
    ...
    public void setMultiLogin(String multiLogin) {
        this.multiLogin = multiLogin == null ? null : multiLogin.trim();
    }
