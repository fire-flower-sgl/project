...
public class PageUtilToSql {
   /* @Value("${database.type}")
     ...
     * @return
     */
    public static String getPageSql(String sql, Pageable pageable,String databaseType) {
        return getPageSql(sql, null, pageable, false,databaseType);
    }
     ...
     * @return
     */
    public static String getPageSql(String sql, Object[] params, Pageable pageable, boolean isOrder,String databaseType) {
