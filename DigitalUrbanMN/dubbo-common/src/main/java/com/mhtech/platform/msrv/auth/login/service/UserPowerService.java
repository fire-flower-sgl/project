...
public interface UserPowerService {
	...
	boolean deleteRoleByRoleNum(String userCode, String roleNum);//删除用户具体某个角色
	...
	boolean deletePowerByPowerNum(String roleNum, String powerNum);//删除角色具体某个权限
	...
	boolean isAccountExist(String contect);//验证手机号/邮箱是否存在

	boolean isUserCodeExist(String contect);//验证用户账号是否存在
