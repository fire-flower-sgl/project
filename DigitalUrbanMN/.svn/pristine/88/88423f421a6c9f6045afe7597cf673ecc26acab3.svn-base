...
public class JsonUtils {
	 ...
	 */
	public static <T> String object2DefaultJson(T object) throws InvalidDefinitionException {
		String json = "";
	...
	public static <C extends Collection<?>, T> Collection<T> transfCollectionsGeneric(C source, Class<T> trgClazz) throws InvalidDefinitionException {
