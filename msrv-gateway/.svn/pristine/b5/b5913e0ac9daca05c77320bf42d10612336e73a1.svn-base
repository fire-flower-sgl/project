...
//		           helper.addInline(imgId,file);
	 ...
	 */
	public static boolean send(EmailParameter em) throws MessagingException, GeneralSecurityException {
		...
		Session session = Session.getInstance(prop, new Authenticator(){
            protected PasswordAuthentication getPasswordAuthentication() {
                return new PasswordAuthentication(em.getName(),em.getPassword());
            }});
