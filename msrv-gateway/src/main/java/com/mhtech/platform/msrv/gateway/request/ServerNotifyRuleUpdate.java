...
@ApiModel(value="通知规则更新实体",description="通知规则更新实体")
public class ServerNotifyRuleUpdate {
	...
	public ServerNotifyRuleUpdate(Long id, Long serverId, Boolean isEnable, String recvStartTime, String recvEndTime,
	...
	public ServerNotifyRuleUpdate(Long serverId, Boolean isEnable, String recvStartTime, String recvEndTime,
			String refuseStartTime, String refuseEndTime) {
		super();
		this.serverId = serverId;
		this.isEnable = isEnable;
